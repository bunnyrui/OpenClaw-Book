...
> 本篇是面向实际使用者的入门到进阶教程，无需阅读源码分析即可上手。如果你是开发者，建议先读完本篇再进入第一部分。

### 指南第 1 章 OpenClaw 实战入门

- **[G1.1 安装与首次启动](ZH/指南第1章-OpenClaw实战入门/G1.1-安装与首次启动.md)**
  - G1.1.1 环境准备：Node.js 22+
  - G1.1.2 安装 OpenClaw：npm 全局安装
  - G1.1.3 引导向导：`openclaw onboard`
  - G1.1.4 发送第一条消息：`openclaw agent`
- **[G1.2 基础配置与通道连接](ZH/指南第1章-OpenClaw实战入门/G1.2-基础配置与通道连接.md)**
  - G1.2.1 配置文件结构：`openclaw.json`
  - G1.2.2 连接 Telegram Bot
  - G1.2.3 连接 Discord Bot
  - G1.2.4 其他通道概览
- **[G1.3 定时任务与工具使用](ZH/指南第1章-OpenClaw实战入门/G1.3-定时任务与工具使用.md)**
  - G1.3.1 工具概念：AI Agent 的执行能力
  - G1.3.2 Bash 工具与浏览器工具
  - G1.3.3 创建第一个定时任务

### 指南第 2 章 Skills 生态与平台集成

- **[G2.1 Skills 安装与使用](ZH/指南第2章-Skills生态与平台集成/G2.1-Skills安装与使用.md)**
  - G2.1.1 技能类型：内置 / 托管 / 工作区
  - G2.1.2 安装与配置技能
  - G2.1.3 实战：coding-agent、github、weather
  - G2.1.4 编写自定义技能
- **[G2.2 多模型配置与切换](ZH/指南第2章-Skills生态与平台集成/G2.2-多模型配置与切换.md)**
  - G2.2.1 模型提供者配置
  - G2.2.2 模型回退链
  - G2.2.3 免费模型与中国模型（DeepSeek / Qwen / Moonshot）
- **[G2.3 中国平台集成](ZH/指南第2章-Skills生态与平台集成/G2.3-中国平台集成.md)**
  - G2.3.1 飞书 / 钉钉 / 企业微信扩展
  - G2.3.2 国内部署注意事项

### 指南第 3 章 多 Agent 与高级自动化

- **[G3.1 多 Agent 架构实践](ZH/指南第3章-多Agent与高级自动化/G3.1-多Agent架构实践.md)**
  - G3.1.1 多 Agent 配置与路由
  - G3.1.2 子代理协作
  - G3.1.3 跨 Agent 通信
- **[G3.2 高级自动化场景](ZH/指南第3章-多Agent与高级自动化/G3.2-高级自动化场景.md)**
  - G3.2.1 自愈服务器
  - G3.2.2 自动化 DevOps 流水线
  - G3.2.3 邮件自动处理与定时报告
- **[G3.3 进阶技巧与最佳实践](ZH/指南第3章-多Agent与高级自动化/G3.3-进阶技巧与最佳实践.md)**
  - G3.3.1 记忆系统优化
  - G3.3.2 安全加固
  - G3.3.3 性能调优与 Docker 部署
...
- **[1.1 什么是 OpenClaw：个人 AI 助手的设计哲学](ZH/第01章-认识OpenClaw/1.1-什么是OpenClaw.md)**
...
- **[1.2 OpenClaw 的核心架构总览](ZH/第01章-认识OpenClaw/1.2-核心架构总览.md)**
...
- **[1.3 技术栈全景](ZH/第01章-认识OpenClaw/1.3-技术栈全景.md)**
...
- **[1.4 项目目录结构详解](ZH/第01章-认识OpenClaw/1.4-项目目录结构详解.md)**
...
- **[2.1 环境准备](ZH/第02章-快速上手与开发环境/2.1-环境准备.md)**
  - 2.1.1 Node.js 22+、pnpm 安装
  - 2.1.2 从源码克隆与构建（`pnpm install && pnpm build`）
  - 2.1.3 UI 构建（`pnpm ui:build`）
- **[2.2 引导向导（Onboarding Wizard）](ZH/第02章-快速上手与开发环境/2.2-引导向导.md)**
...
- **[2.3 启动 Gateway 守护进程](ZH/第02章-快速上手与开发环境/2.3-启动Gateway守护进程.md)**
  - 2.3.1 前台启动 vs 守护进程模式（`src/daemon/`）
  - 2.3.2 launchd / systemd 服务安装的源码分析
- **[2.4 开发循环](ZH/第02章-快速上手与开发环境/2.4-开发循环.md)**
...
- **[3.1 Gateway 的角色与设计目标](ZH/第03章-Gateway服务器架构/3.1-Gateway的角色与设计目标.md)**
...
- **[3.2 服务器启动流程源码分析](ZH/第03章-Gateway服务器架构/3.2-服务器启动流程源码分析.md)**
...
- **[3.3 WebSocket 服务器实现](ZH/第03章-Gateway服务器架构/3.3-WebSocket服务器实现.md)**
...
- **[3.4 HTTP 层](ZH/第03章-Gateway服务器架构/3.4-HTTP层.md)**
...
- **[4.1 协议设计哲学](ZH/第04章-Gateway协议与类型系统/4.1-协议设计哲学.md)**
  - 4.1.1 为什么选择 WebSocket 而非 REST
  - 4.1.2 请求-响应 + 服务器推送事件的混合模式
  - 4.1.3 幂等键（Idempotency Key）机制防止重复操作
- **[4.2 TypeBox 类型模式（Schema）](ZH/第04章-Gateway协议与类型系统/4.2-TypeBox类型模式.md)**
...
- **[4.3 核心方法与事件](ZH/第04章-Gateway协议与类型系统/4.3-核心方法与事件.md)**
...
- **[4.4 认证与授权](ZH/第04章-Gateway协议与类型系统/4.4-认证与授权.md)**
...
- **[5.1 会话模型设计](ZH/第05章-会话管理/5.1-会话模型设计.md)**
...
- **[5.2 会话路由源码分析](ZH/第05章-会话管理/5.2-会话路由源码分析.md)**
...
- **[5.3 会话生命周期](ZH/第05章-会话管理/5.3-会话生命周期.md)**
...
- **[6.3 出站消息处理](ZH/第06章-通道路由与消息分发/6.3-出站消息处理.md)**
...
- **[6.4 多代理路由](ZH/第06章-通道路由与消息分发/6.4-多代理路由.md)**
...
- **[7.1 Pi Agent 是什么](ZH/第07章-PiAgent运行时核心/7.1-PiAgent是什么.md)**
...
- **[7.2 Agent Loop（代理循环）端到端解析](ZH/第07章-PiAgent运行时核心/7.2-AgentLoop端到端解析.md)**
...
- **[7.3 队列与并发控制](ZH/第07章-PiAgent运行时核心/7.3-队列与并发控制.md)**
...
- **[7.4 超时与中止机制](ZH/第07章-PiAgent运行时核心/7.4-超时与中止机制.md)**
...
- **[8.1 模型选择机制](ZH/第08章-模型提供者与故障转移/8.1-模型选择机制.md)**
...
- **[8.2 Auth Profile 与凭据管理](ZH/第08章-模型提供者与故障转移/8.2-AuthProfile与凭据管理.md)**
...
- **[8.3 模型目录与配置](ZH/第08章-模型提供者与故障转移/8.3-模型目录与配置.md)**
...
- **[8.4 故障转移错误处理](ZH/第08章-模型提供者与故障转移/8.4-故障转移错误处理.md)**
...
- **[9.1 系统提示词的构建](ZH/第09章-系统提示词与上下文组装/9.1-系统提示词的构建.md)**
...
- **[9.2 工作区与上下文文件注入](ZH/第09章-系统提示词与上下文组装/9.2-工作区与上下文文件注入.md)**
...
- **[9.3 身份系统](ZH/第09章-系统提示词与上下文组装/9.3-身份系统.md)**
  - 9.3.1 AI 助手身份（`src/agents/identity.ts`）
  - 9.3.2 身份文件（`src/agents/identity-file.ts`）
  - 9.3.3 身份头像（`src/agents/identity-avatar.ts`）
  - 9.3.4 通道前缀身份
- **[9.4 上下文压缩（Compaction）](ZH/第09章-系统提示词与上下文组装/9.4-上下文压缩.md)**
  - 9.4.1 自动压缩触发机制
  - 9.4.2 压缩流程（`src/agents/compaction.ts`）
  - 9.4.3 压缩前的记忆刷新（Memory Flush）
  - 9.4.4 压缩重试与缓冲重置
- **[9.5 Context Engine 插件系统](ZH/第09章-系统提示词与上下文组装/9.5-Context Engine插件系统.md)**
  - 9.5.1 为什么需要 Context Engine
  - 9.5.2 插件接口（ContextEngine Interface）
  - 9.5.3 注册与解析机制
  - 9.5.4 LegacyContextEngine 向后兼容
  - 9.5.5 运行时集成
  - 9.5.6 开发自定义 Context Engine

### 第 10 章 流式传输与分块回复

- **[10.1 流式传输架构](ZH/第10章-流式传输与分块回复/10.1-流式传输架构.md)**
...
- **[10.2 块流（Block Streaming）](ZH/第10章-流式传输与分块回复/10.2-块流.md)**
...
- **[10.3 合并（Coalescing）与人性化节奏](ZH/第10章-流式传输与分块回复/10.3-合并与人性化节奏.md)**
  - 10.3.1 连续块合并策略：空闲间隙、最小/最大字符数
  - 10.3.2 人性化延迟（Human Delay）：`natural` / `custom` 模式
- **[10.4 Telegram 草稿流](ZH/第10章-流式传输与分块回复/10.4-Telegram草稿流.md)**
  - 10.4.1 `sendMessageDraft` 的实现
  - 10.4.2 partial 模式 vs block 模式
- **[10.5 回复塑形与抑制](ZH/第10章-流式传输与分块回复/10.5-回复塑形与抑制.md)**
...
- **[11.1 通道适配器设计模式](ZH/第11章-通道适配器抽象层/11.1-通道适配器设计模式.md)**
...
- **[12.1 WhatsApp 通道（Baileys）](ZH/第12章-核心通道实现深入/12.1-WhatsApp通道.md)**
...
- **[13.3 代表性扩展实现解析](ZH/第13章-通道扩展机制/13.3-代表性扩展实现解析.md)**
  ...
  - 13.3.8 LINE 扩展
- **[13.4 开发自定义扩展](ZH/第13章-通道扩展机制/13.4-开发自定义扩展.md)**
  - 13.4.1 扩展脚手架搭建
  - 13.4.2 实现通道适配器接口
  - 13.4.3 注册到插件系统
  - 13.4.4 测试与调试
...
- **[14.1 工具的定义与分类](ZH/第14章-工具系统总览/14.1-工具系统架构.md)**
...
- **[14.2 工具注册与策略](ZH/第14章-工具系统总览/14.2-工具执行运行时.md)**
...
- **[14.3 工具执行与结果处理](ZH/第14章-工具系统总览/14.3-工具权限与策略.md)**
...
- **[14.4 执行审批机制](ZH/第14章-工具系统总览/14.4-工具与Agent的协作.md)**
  - 14.4.1 执行审批管理器（`src/gateway/exec-approval-manager.ts`）
  - 14.4.2 用户审批工作流

### 第 15 章 Bash 工具与进程管理

- **[15.1 Bash 执行引擎](ZH/第15章-Bash工具与进程管理/15.1-Bash执行引擎.md)**
...
- **[16.2 CDP 层实现](ZH/第16章-浏览器控制/16.2-CDP层实现.md)**
...
- **[16.3 Playwright 层实现](ZH/第16章-浏览器控制/16.3-Playwright层实现.md)**
  ...
  - 16.3.4 Playwright 工具核心（`src/browser/pw-tools-core.ts`）：
    ...
    - 下载处理（`downloads.ts`）
    - 存储管理（`storage.ts`）
- **[16.4 浏览器服务器](ZH/第16章-浏览器控制/16.4-浏览器服务器.md)**
...
- **[17.1 Canvas 概念](ZH/第17章-Canvas与A2UI/17.1-Canvas概念.md)**
...
- **[17.2 Canvas Host 实现](ZH/第17章-Canvas与A2UI/17.2-Canvas-Host实现.md)**
...
- **[17.3 Canvas 工具](ZH/第17章-Canvas与A2UI/17.3-Canvas工具.md)**
  - 17.3.1 push / reset / eval / snapshot 操作
  - 17.3.2 Canvas 在 macOS / iOS / Android 上的表面

### 第 18 章 Cron 调度与自动化

- **[18.1 Cron 系统设计](ZH/第18章-Cron调度与自动化/18.1-Cron系统设计.md)**
...
- **[18.2 Cron 作业执行](ZH/第18章-Cron调度与自动化/18.2-Cron作业执行.md)**
...
- **[18.3 Webhook 与 Gmail Pub/Sub](ZH/第18章-Cron调度与自动化/18.3-Webhook与Gmail-PubSub.md)**
  - 18.3.1 Webhook 触发器
...
- **[19.1 节点概念](ZH/第19章-节点系统/19.1-节点概念.md)**
...
- **[19.2 节点注册与发现](ZH/第19章-节点系统/19.2-节点注册与发现.md)**
...
- **[19.3 节点 Host 实现](ZH/第19章-节点系统/19.3-节点Host实现.md)**
...
- **[20.3 混合搜索（BM25 + 向量）](ZH/第20章-记忆系统/20.3-混合搜索.md)**
  - 20.3.1 BM25 全文搜索原理
  - 20.3.2 混合检索实现（`src/memory/hybrid.ts`）
  - 20.3.3 分数融合策略：加权线性组合
- **[20.4 高级记忆功能](ZH/第20章-记忆系统/20.4-高级记忆功能.md)**
...
- **[21.4 ClawHub 技能注册中心](ZH/第21章-技能系统/21.4-ClawHub技能注册中心.md)**
  - 21.4.1 ClawHub 的设计与功能
  - 21.4.2 技能自动搜索与安装

### 第 22 章 钩子系统

- **[22.1 内部钩子（Gateway Hooks）](ZH/第22章-钩子系统/22.1-内部钩子.md)**
...
- **[22.2 插件钩子（Plugin Hooks）](ZH/第22章-钩子系统/22.2-插件钩子.md)**
...
- **[23.1 配置加载与解析](ZH/第23章-配置系统/23.1-配置加载与解析.md)**
...
- **[23.2 配置类型系统详解](ZH/第23章-配置系统/23.2-配置类型系统详解.md)**
...
- **[23.3 配置热重载](ZH/第23章-配置系统/23.3-配置热重载.md)**
...
- **[24.3 沙箱机制](ZH/第24章-安全模型/24.3-沙箱机制.md)**
  ...
  - 24.3.5 工具白名单 / 黑名单
- **[24.4 安全审计](ZH/第24章-安全模型/24.4-安全审计.md)**
...
- **[26.3 链接理解与媒体理解](ZH/第26章-基础设施/26.3-链接理解与媒体理解.md)**
  - 26.3.1 链接理解（`src/link-understanding/`）
  - 26.3.2 媒体理解（`src/media-understanding/`）
- **[26.4 TTS（文本转语音）](ZH/第26章-基础设施/26.4-TTS文本转语音.md)**
  - 26.4.1 TTS 引擎（`src/tts/`）
  - 26.4.2 ElevenLabs / Edge TTS 集成
- **[26.5 投票系统](ZH/第26章-基础设施/26.5-投票系统.md)**
...
- **[27.1 UI 技术选型](ZH/第27章-Web控制台UI/27.1-UI技术选型.md)**
...
- **[27.2 控制台 UI 架构](ZH/第27章-Web控制台UI/27.2-控制台UI架构.md)**
  - 27.2.1 Gateway 内嵌 UI 服务（`src/gateway/control-ui.ts`）
  - 27.2.2 UI 源码结构（`ui/src/`）
  - 27.2.3 Gateway WebSocket 客户端
- **[27.3 WebChat 实现](ZH/第27章-Web控制台UI/27.3-WebChat实现.md)**
  - 27.3.1 WebChat 作为 Gateway WS 客户端
  - 27.3.2 聊天历史加载与消息发送

### 第 28 章 原生客户端应用

- **[28.1 macOS 应用（OpenClaw.app）](ZH/第28章-原生客户端应用/28.1-macOS应用.md)**
...
- **[28.2 iOS 节点应用](ZH/第28章-原生客户端应用/28.2-iOS节点应用.md)**
  - 28.2.1 Bonjour 配对
  - 28.2.2 Canvas 表面
  - 28.2.3 Voice Wake / Talk Mode
  - 28.2.4 摄像头与屏幕录制
- **[28.3 Android 节点应用](ZH/第28章-原生客户端应用/28.3-Android节点应用.md)**
  - 28.3.1 Kotlin 架构
  - 28.3.2 Canvas / 摄像头 / 屏幕录制
  - 28.3.3 可选 SMS 支持
- **[28.4 共享组件](ZH/第28章-原生客户端应用/28.4-共享组件.md)**
...
- **[29.4 Nix 声明式部署](ZH/第29章-部署方案/29.4-Nix声明式部署.md)**
- **[29.5 VPS 部署（`docs/vps.md`）](ZH/第29章-部署方案/29.5-VPS部署.md)**

### 第 30 章 监控与故障排查

- **[30.1 健康检查](ZH/第30章-监控与故障排查/30.1-健康检查.md)**
  - 30.1.1 Gateway 健康端点
  - 30.1.2 Gateway 探针（`src/gateway/probe.ts`）
  - 30.1.3 心跳机制
- **[30.2 在线追踪（Presence）](ZH/第30章-监控与故障排查/30.2-在线追踪.md)**
  - 30.2.1 在线状态管理
  - 30.2.2 打字指示器
- **[30.3 用量追踪](ZH/第30章-监控与故障排查/30.3-用量追踪.md)**
  - 30.3.1 Token 用量统计（`src/agents/usage.ts`）
  - 30.3.2 用量展示选项：off / tokens / full
- **[30.4 故障排查](ZH/第30章-监控与故障排查/30.4-故障排查.md)**
...
- **[31.1 多代理设计](ZH/第31章-多代理架构/31.1-多代理设计.md)**
...
- **[31.2 子代理（Sub-agent）](ZH/第31章-多代理架构/31.2-子代理.md)**
...
- **[31.3 多代理沙箱工具](ZH/第31章-多代理架构/31.3-多代理沙箱工具.md)**
  - 31.3.1 跨代理工具隔离
  - 31.3.2 沙箱代理配置

### 第 32 章 ACP（Agent Communication Protocol）

- **[32.1 ACP 协议概述](ZH/第32章-ACP/32.1-ACP协议概述.md)**
  > **衍生解释**：ACP 是一种 Agent 间通信协议标准，允许不同 AI Agent 之间进行结构化通信。
  - 32.1.1 `@agentclientprotocol/sdk` 依赖
  - 32.1.2 `src/acp/` — OpenClaw 的 ACP 实现
- **[32.2 ACP 会话管理与运行时](ZH/第32章-ACP/32.2-ACP会话管理与运行时.md)**
  - 32.2.1 会话存储（AcpSessionStore）
  - 32.2.2 会话键解析（Session Key Resolution）
  - 32.2.3 会话恢复（Session Resume）
  - 32.2.4 会话身份追踪（Session Identity）
  - 32.2.5 会话元数据持久化
  - 32.2.6 运行时缓存与驱逐
- **[32.3 ACP 控制面与集成模式](ZH/第32章-ACP/32.3-ACP控制面与集成模式.md)**
  - 32.3.1 控制面架构
  - 32.3.2 来源追踪（Provenance）
  - 32.3.3 工具流式增强
  - 32.3.4 持久化绑定（Persistent Bindings）
  - 32.3.5 运行时控制与配置
  - 32.3.6 错误处理与安全

### 第 33 章 TUI（终端用户界面）

- **[33.1 TUI 架构](ZH/第33章-TUI/33.1-TUI架构.md)**
  - 33.1.1 `@mariozechner/pi-tui` 集成
  - 33.1.2 `src/tui/` — TUI 适配层
  - 33.1.3 终端渲染（`src/terminal/`）
- **[33.2 TUI 交互机制](ZH/第33章-TUI/33.2-TUI交互机制.md)**
  - 33.2.1 事件处理管线
  - 33.2.2 Gateway 事件处理
  - 33.2.3 命令系统详解
  - 33.2.4 会话操作
  - 33.2.5 本地 Shell 执行
  - 33.2.6 键盘快捷键与输入优化
- **[33.3 TUI 高级特性](ZH/第33章-TUI/33.3-TUI高级特性.md)**
  - 33.3.1 文本清理与安全渲染
